...
/* Notice remove BoxShop Importer */
add_action( 'admin_notices', 'boxshop_remove_plugin_notice' );
function boxshop_remove_plugin_notice(){
	if( class_exists('TS_Boxshop_Importer') ){
		?>
		<div class="notice notice-error">
			<p><?php esc_html_e('The BoxShop Importer plugin is not used anymore. You can remove it!', 'boxshop'); ?></p>
		</div>
		<?php
...
function boxshop_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.6.1.0.zip'
            ,'required'           => true
			,'version'            => '6.1.0'
            ,'external_url'       => ''
        )
		...
		,array(
            'name'                => 'Contact Form 7'
            ,'slug'               => 'contact-form-7'
			,'source'             => 'https://downloads.wordpress.org/plugin/contact-form-7.5.5.3.zip'
            ,'required'           => false
			,'version'            => '5.5.3'
            ,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.3.4.0.zip'
            ,'required'           => false
			,'version'            => '3.4.0'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-compare.2.9.0.zip'
            ,'required'           => false
			,'version'            => '2.9.0'
            ,'external_url'       => ''
        )

...
$rocket_cookie_hash = 'bde6174798472b2ef0448940c592261d';
$rocket_logged_in_cookie = 'wordpress_logged_in_bde6174798472b2ef0448940c592261d';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?|/(?:.+/)?embed/|/cart/|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '6385d5c160a85287659512';
$rocket_cache_ssl = 1;
